...
const SportsCard = ({ onAnyCardFlipped9 }) => {
  ...
  const handleFlip = () => {
    setIsFlipped((prev) => {
      ...
      if (typeof onAnyCardFlipped9 === "function") {
        onAnyCardFlipped9(newFlipped);
      }
      return newFlipped;
    });
  };
  ...
  return (
    <div className="other-content">
      <div className="relative w-full mt-[30px]" style={{ zIndex: isFlipped ? 1001 : 998 }}>
        ...
        >
          <div
            className="flip-card-front bg-[#1E1E1F] w-full h-[750px] max-tab:!h-[510px] max-md:!h-[580px] max-tab:relative rounded-[40px] flex flex-row-reverse max-md:flex-col-reverse items-start justify-between gap-11 p-[80px] max-md:px-[30px] px-[100px] overflow-hidden"
            ref={frontRef3}
          >
            <div className="self-center justify-self-center max-md:justify-self-start  max-tab:w-1/2 max-md:w-full">
              ...
              >
                ...
                Sports and life events.
                </span>
                <br />
                <span className="text-white">Just show</span>
                <br />
                <span className="text-white">and go.</span>
              </h3>
            </div>
            <div className="flex items-center justify-end max-md:justify-center  max-tab:w-1/2 h-full max-md:w-full">
              <img
                src="/paymentcomponent/sportswatch.png"
                alt="img"
                className="w-[400px] h-[500px] max-tab:w-[250px] max-md:mx-auto  max-tab:h-[320px] max-md:w-[150px]  max-md:h-[250px] rounded-[50px]"
                data-aos="fade-up"
                data-aos-duration="1500"
              />
            </div>
            ...
            <div className="text-start flex max-md:flex-col gap-5 max-md:gap-20 items-center justify-center text-black px-3 w-full">
              ...
              <div className="w-[50%] max-md:w-full">
                <img
                  ...
                  alt="check"
                  className="-mb-36 w-[380px] max-md:-mb-40 bg-transparent max-md:w-[200px] max-md:mx-auto"
                />
              </div>
